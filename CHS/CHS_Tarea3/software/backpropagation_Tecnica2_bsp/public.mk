...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios_system_T2.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios_system_T2
SOPC_NAME := nios_system_T2
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10001040
SOPC_SYSID_FLAG += --sidp=0x10001040
ELF_PATCH_FLAG  += --sidp 0x10001040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1639592166
SOPC_SYSID_FLAG += --timestamp=1639592166
ELF_PATCH_FLAG  += --timestamp 1639592166
