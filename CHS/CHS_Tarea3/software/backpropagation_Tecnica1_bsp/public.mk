...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios_system_T1.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios_system_T1
SOPC_NAME := nios_system_T1
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1639591488
SOPC_SYSID_FLAG += --timestamp=1639591488
ELF_PATCH_FLAG  += --timestamp 1639591488
