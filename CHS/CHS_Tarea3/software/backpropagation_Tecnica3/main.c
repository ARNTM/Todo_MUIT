...
#define ALT_CI_TANHCUSTOM_0(n,A) __builtin_custom_fnf(ALT_CI_TANHCUSTOM_0_N+(n&ALT_CI_TANHCUSTOM_0_N_MASK),(A))
...
//#define ACELERACION2  //ACELERACION DE OBTENER UNA APROXIMACION DE LA DERIVADA DE LA tanh_component sea periferico o instruccion
