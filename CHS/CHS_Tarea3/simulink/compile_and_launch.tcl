proc vsimulink {args} {
  lappend sllibarg -foreign \{simlinkserver \{C:/Program Files/MATLAB/R2018a/toolbox/edalink/extensions/modelsim/windows64/liblfmhdls_gcc450vc12.dll\}
...
proc vsimmatlab {args} {
  lappend mllibarg -foreign \{matlabclient \{C:/Program Files/MATLAB/R2018a/toolbox/edalink/extensions/modelsim/windows64/liblfmhdlc_gcc450vc12.dll\}
  lappend mllibarg \}
  lappend mlinput 
...
proc vsimmatlabsysobj {args} {
  lappend sllibarg -foreign \{matlabsysobjserver \{C:/Program Files/MATLAB/R2018a/toolbox/edalink/extensions/modelsim/windows64/liblfmhdls_gcc450vc12.dll\}
  if {[catch {lsearch -exact $args -socket} idx]==0  && $idx >= 0} {
    set socket [lindex $args [expr {$idx + 1}]]
    set args [lreplace $args $idx [expr {$idx + 1}]]
    append socketarg " \; -socket " "$socket"
