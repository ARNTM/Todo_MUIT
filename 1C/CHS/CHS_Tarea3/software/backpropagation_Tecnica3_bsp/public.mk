...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios_system_T3.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios_system_T3
SOPC_NAME := nios_system_T3
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1639593227
SOPC_SYSID_FLAG += --timestamp=1639593227
ELF_PATCH_FLAG  += --timestamp 1639593227
