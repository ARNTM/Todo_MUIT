...
OS_STK    getmutex_task1_stk[TASK_STACKSIZE];
OS_STK    getmutex_task2_stk[TASK_STACKSIZE];
...
OS_STK	  read_pushbuttons_stk[TASK_STACKSIZE];
...
#define READ_PUSHBUTTONS_PRIORITY	4
#define GETSEM_TASK3_PRIORITY      13
#define GETSEM_TASK4_PRIORITY      14
#define QUERYSEM_PRIORITY      15
#define PIP_PRIORITY_INHERITANCE 4
#define GETMUTEX_TASK1_PRIO      16
#define GETMUTEX_TASK2_PRIO      17
